...
for an article at the publisher end of the network, using the ipc protocol in the
...
int main(int argc, char *argv[]){
    ...
    int result = setup_publisher(argv[1]);
    printf("publisher setup result: %d\n", result);
    if (result == NITS_SOCKET_ERROR) {
